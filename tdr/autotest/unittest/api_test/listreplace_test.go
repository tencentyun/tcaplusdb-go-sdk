...
func TestListReplaceSuccess(t *testing.T) {
	...
	/*------------------------------------------------------- 获取记录 ------------------------------------------*/
	client, req = tools.InitClientAndReqWithTableName(cmd.TcaplusApiListReplaceReq, "table_traverser_list")
	...
	/*------------------------------------------------------- 获取记录 ------------------------------------------*/
	client, req = tools.InitClientAndReqWithTableName(cmd.TcaplusApiListGetReq, "table_traverser_list")
