...
func (r *RunTest) TestReplace() error {
	req, err := r.TcaplusClient.NewRequest(uint32(r.TcaplusCase.Head.ZoneID), r.TcaplusCase.Head.TableName, cmd.TcaplusApiReplaceReq)
	if err != nil {
