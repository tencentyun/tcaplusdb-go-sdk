...
func deleteByPartKeyExample() {
	...
	req, err := client.NewRequest(tools.Zone, "game_players", cmd.TcaplusApiDeleteByPartkeyReq)
	if err != nil {
	...
	logger.INFO("del by part key success")
	fmt.Println("del by part key success")
}
