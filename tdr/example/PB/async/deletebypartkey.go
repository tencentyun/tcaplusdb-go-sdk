...
func deleteByPartKeyExample() {
	...
	req, err := client.NewRequest(tools.ZoneId, "game_players", cmd.TcaplusApiDeleteByPartkeyReq)
	if err != nil {
	...
	wg.Wait()
	logger.INFO("delete by part key success")
	fmt.Println("delete by part key success")
}
