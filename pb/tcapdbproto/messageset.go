...
func (o MarshalOptions) sizeMessageSet(m protoreflect.Message) (size int) {
	m.Range(func(fd protoreflect.FieldDescriptor, v protoreflect.Value) bool {
		size += SizeField(fd.Number())
		size += protowire.SizeTag(FieldMessage)
		size += protowire.SizeBytes(o.size(v.Message()))
		return true
	})
	size += SizeUnknown(m.GetUnknown())
	return size
}
...
func (o MarshalOptions) marshalMessageSet(b []byte, m protoreflect.Message) ([]byte, error) {
	...
	fieldOrder := AnyFieldOrder
	if o.Deterministic {
		fieldOrder = NumberFieldOrder
	}
	var err error
	RangeFields(m, fieldOrder, func(fd protoreflect.FieldDescriptor, v protoreflect.Value) bool {
	...
	return AppendUnknown(b, m.GetUnknown())
}

func (o MarshalOptions) marshalMessageSetField(b []byte, fd protoreflect.FieldDescriptor, value protoreflect.Value) ([]byte, error) {
	b = AppendFieldStart(b, fd.Number())
...
func MessageSetUnmarshal(b []byte, wantLen bool, fn func(typeID protowire.Number, value []byte) error) error {
	for len(b) > 0 {
