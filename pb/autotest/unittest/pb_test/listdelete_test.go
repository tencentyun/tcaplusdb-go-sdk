...
func TestListDeleteSuccess(t *testing.T) {
	...
	/*------------------------------------------------------- 删除记录 ------------------------------------------*/
	client, req = tools.InitPBClientAndReqWithTableName(cmd.TcaplusApiListDeleteReq, "tb_online_list")
...
// 条件符合
func TestListDeleteWithCondition(t *testing.T) {
	...
	client, req := tools.InitPBClientAndReqWithTableName(cmd.TcaplusApiListDeleteReq, "list_user")
...
// 条件不符
func TestListDeleteWithCondition_Fail(t *testing.T) {
	data := &tcaplusservice.ListUser{}
	data.Id = 1
	data.Name = "a"
	data.Rank = 100
